...
void loop() {
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
   ...
   if (state == 1){ // if FORWARD trial
      if (lickmeterState2==aMouse && pos2_forward){
          if (pos7_forward){
              digitalWrite(solPin7, HIGH);    // ON
              digitalWrite(solTTLPin7, HIGH); // ON  
              delay(caudal7);
      ...
      if (lickmeterState3==aMouse && pos3_forward){
          if (pos7_forward){
              digitalWrite(solPin7, HIGH);    // ON
              digitalWrite(solTTLPin7, HIGH); // ON  
              delay(caudal7);
      ...
      if (lickmeterState4==aMouse && pos4_forward){
          if (pos7_forward){
              digitalWrite(solPin7, HIGH);    // ON
              digitalWrite(solTTLPin7, HIGH); // ON  
              delay(caudal7);
      ...
      if (lickmeterState5==aMouse && pos5_forward){
          if (pos7_forward){
              digitalWrite(solPin7, HIGH);    // ON
              digitalWrite(solTTLPin7, HIGH); // ON  
              delay(caudal7);
      ...
      if (lickmeterState6==aMouse && pos6_forward){
          if (pos7_forward){
              digitalWrite(solPin7, HIGH);    // ON
              digitalWrite(solTTLPin7, HIGH); // ON  
              delay(caudal7);
